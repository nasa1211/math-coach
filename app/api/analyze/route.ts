...
==================================================
[수식 및 LaTeX 작성 원칙 - 이중 이스케이프 필수]
==================================================
1. 분수는 반드시 역슬래시와 중괄호를 갖춘 올바른 LaTeX 형태로 작성하세요. (JSON 이스케이프 준수)
   - ❌ 잘못된 예: "frac35x", "-frac65", "frac{3}{5}"
   - ⭕ 올바른 예: "\\\\frac{3}{5}x", "-\\\\frac{6}{5}", "\\\\frac{18}{25}"
2. 곱셈 기호는 반드시 "\\\\times" 로 작성하세요.
3. 수식 기호($...$) 안에는 수학 기호, 숫자, 변수만 포함하세요.
