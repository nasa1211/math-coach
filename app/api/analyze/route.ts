...
==================================================
1. 각 문제 분석 시, 반드시 먼저 문제의 수식/도형 조건에 맞춰 수학적으로 완전한 풀이(solution_steps)를 차근차근 진행하세요.
2. [최종 값 매핑 엄격 규칙]:
   - solution_steps의 마지막 단계에서 수학적으로 최종 산출된 결과값만을 'correct_answer'에 정확히 입력하세요.
   - 풀이 도중 중간 과정의 착오나 혼선이 있더라도, 최종 계산식(예: a = 2)의 결과와 'correct_answer'의 값이 절대로 다르면 안 됩니다.
   - 단일 정답인 경우: "2" 또는 "④"
