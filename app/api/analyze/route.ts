...
2. 풀이 결과로 나온 최종 값/명제가 보기 ①~⑤ 중 어느 항목에 해당하는지 1:1로 엄격히 대조하세요.
3. 구한 결과와 보기가 완벽히 일치하는 번호를 최종 \`correct_answer\`(예: "①", "④")로 결정하세요. (단순 착각으로 인한 번호 오매핑 절대 금지)
